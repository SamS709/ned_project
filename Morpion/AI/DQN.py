...
from Morpion.AI.DNN import *
from Morpion.AI.MorpionAI import *

class DQN(MorpionAI):

    def __init__(self,reset = False, eps = 0.8, P1='1',dim = [27,32,1],learning_rate = 0.05,alpha = 0.8,gamma=0.8):
        super().__init__()
...
if __name__=='__main__':
    train = DQN(reset=True,P1='1')
    grid1 = np.array([1,0,1,1,2,0,2,2,0])
    grid2 = np.array([1,0,1,2,2,0,2,2,0])
    grid3 = np.array([1,0,1,0,2,0,2,2,0])
    print(train.Q_value1(grid1))
    print(train.Q_value2(grid1))
