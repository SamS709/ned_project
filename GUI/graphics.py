...
class TextArea(BoxLayout): # the text area giving informations that you see on the UI
    ...
    def __init__(self,text='Insert text',titre = 'Insert title',**kwargs):
...
class ChoiceGame(BoxLayout): # First menu to choose the game you want to play
    ...
    B1text = StringProperty(D_text_button["tic_tac_toe"][LNG])
    B2text = StringProperty(D_text_button["connect_4"][LNG])
    B5text = StringProperty(D_text_button["confirm"][LNG])
...
class ChoiceMode(BoxLayout): # Makes the user choose between AI and Minimax Algorithm
    ...
    # kivy properties you find in the graphics.kv file (ChoiceGame class)
    B1text = StringProperty(D_text_button["minimax"][LNG])
    B2text = StringProperty(D_text_button["ai"][LNG])
    B5text = StringProperty(D_text_button["confirm"][LNG])
    opponent_choice = D_static_texts["opponent_choice"][LNG]
    ...
    def on_kv_post(self, text='a'):
        ...
        self.ZdT.text = D_static_texts["explain_minimax_vs_ai"][LNG]
        self.ZdT.title = f'[u]{D_static_texts["question_opponent_choice"][LNG]}[/u]'
    ...
    def pressB(self, instance):
        if instance.text == self.B1text:
            ...
            self.colors1 = SAND
            self.ZdT.text = D_static_texts["minimax_pressed"][LNG]
            self.Ntrain = 0
            self.colors2 = BLUE
            self.ids.B2.color = WHITE
            self.colors5 = GREEN
        ...
        if instance.text == self.B2text:
            self.screen = 'ChoiceLevel'
            self.colors2 = SAND
            self.ZdT.text = D_static_texts["ai_pressed"][LNG]
            self.Ntrain = 1000
            self.colors1 = BLUE
            self.ids.B1.color = WHITE
            self.colors5 = GREEN
...
class ChoiceLevel(BoxLayout): # Makes the user choose the level (number of trains for AI and depth exploration for minimax algorithm)
    ...
    # kivy properties you find in the graphics.kv file (ChoiceGame class)
    B1text = StringProperty(D_text_button["novice"][LNG])
    B2text = StringProperty(D_text_button["beginner"][LNG])
    B3text = StringProperty(D_text_button["intermediate"][LNG])
    B4text = StringProperty(D_text_button["expert"][LNG])
    B5text = StringProperty(D_text_button["confirm"][LNG])
    ...
    titre = StringProperty(D_static_texts["level_choice"][LNG])
    ...
    def on_kv_post(self, base_widget):
        ...
        self.ZdT = TextArea(text='coucou')
        self.ZdT.title = f'[u]{D_static_texts["question_level_choice"][LNG]}[/u]'
        if self.mode == 'IA':
            self.B1text = D_text_button["beginner"][LNG]
            self.B2text = D_text_button["intermediate"][LNG]
            self.B3text = D_text_button["expert"][LNG]
            self.B4text = D_text_button["custom"][LNG]
            self.titre = D_static_texts["level_choice_ai"][LNG]
            self.ZdT.text = D_static_texts["level_choice_ai_advice"][LNG]
        else:
            self.titre = D_static_texts["level_choice_minimax"][LNG]
            self.ZdT.text = D_static_texts["level_choice_minimax_advice"][LNG]
        self.ids.zdt.add_widget(self.ZdT)
    ...
    def pressB(self, instance):
        if instance.text == self.B1text:
            ...
            if var1.MODE == 'IA':
                self.ZdT.text = D_static_texts["level_choice_ai_beginner"][LNG]
            else:
                self.ZdT.text = D_static_texts["level_choice_minimax_novice"][LNG]
        ...
        if instance.text == self.B2text:
            ...
            if var1.MODE == 'IA':
                self.ZdT.text = D_static_texts["level_choice_ai_intermediate"][LNG]
            else:
                self.ZdT.text = D_static_texts["level_choice_minimax_beginner"][LNG]
        ...
        if instance.text == self.B3text:
            ...
            if var1.MODE == 'IA':
                self.ZdT.text = D_static_texts["level_choice_ai_expert"][LNG]
            else:
                self.ZdT.text = D_static_texts["level_choice_minimax_intermediate"][LNG]
        ...
        if instance.text == self.B4text:
            ...
            if var1.MODE == 'IA':
                self.ZdT.text = D_static_texts["level_choice_ai_custom"][LNG]
            else:
                self.ZdT.text = D_static_texts["level_choice_minimax_expert"][LNG]
...
class MySettings(ChoiceLevel): # Settings menu
    ...
    opponent_choice = StringProperty("")
    ...
    def on_kv_post(self, base_widget):
        super().on_kv_post(base_widget)
        self.ZdT.text = D_static_texts["parameter_choice"][LNG]
        self.titre = D_static_texts["parameter_title"][LNG]
        self.B1text = D_text_button["parameter_language"][LNG]
        self.B2text = D_text_button["tic_tac_toe"][LNG]
        self.B3text = D_text_button["connect_4"][LNG]
        self.B4text = D_text_button["chess"][LNG]
    ...
    def pressB(self, instance):
        if instance.text == self.B1text:
            ...
            self.ZdT.text = D_static_texts["parameter_language_info"][LNG]
        ...
        if instance.text == self.B2text:
            ...
            self.colors5 = GREEN
            self.image_source = 'images/morpion.png'
            self.ZdT.text = D_static_texts["parameter_tic_tac_toe_info"][LNG]
        ...
        if instance.text == self.B3text:
            ...
            self.colors5 = GREEN
            self.image_source = 'images/puissance4.png'
            self.ZdT.text = D_static_texts["parameter_connect_4_info"][LNG]
        ...
        if instance.text == self.B4text:
            ...
            self.colors5 = LIGHT_GREEN
            self.image_source = 'images/developpement.png'
            self.ZdT.text = D_static_texts["parameter_chess_info"][LNG]
